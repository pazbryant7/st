...
static char *fonts[] = {
	...
	"Annotation Mono:pixelsize=15.5:style:ExtraBold:antialias=true:autohint=true",
	"Recursive Mn Csl St Med:pixelsize=15.5:style:Medium:antialias=true:autohint=true",
	"Recursive Mn Csl St SmB:pixelsize=15.5:style:SemiBold:antialias=true:autohint=true",
	"Recursive Mn Csl St:pixelsize=15.5:style:Bold:antialias=true:autohint=true",
};

static size_t currentfont = 3;
/* Spare fonts */
static char *font2[] = {
